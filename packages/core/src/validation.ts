 ...
 */
function ajvErrorsToValidationErrors(errors: typeof validateContractSchema.errors): ValidationError[] {
  if (!errors) return [];
...
export function validateContract(data: unknown): ValidationResult {
  ...
  if (valid) {
    ...
    const contract = data as unknown as ComponentContract;
 ...
 * Validate CoreTokens.
 */
export function validateCoreTokens(data: unknown): ValidationResult {
  const valid = validateCoreTokensSchema(data);
  if (valid) return validResult();
 ...
 */
export function validateSemanticTokens(data: unknown): ValidationResult {
 ...
 */
export function validatePlatformRules(data: unknown): ValidationResult {
